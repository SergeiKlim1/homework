def get_mask_card_number(card_number: int) -> str:
    ...
    mask_card = card_number_string[0:6] + (len(card_number_string[6:-4]) * "*") + card_number_string[-4:]
...
def get_mask_account(account_number: int) -> str:
    ...
    mask_account_number = string_account_number.replace(string_account_number[0:-4], "**")
